...
# Usage ./screen-brightness-xrandr.sh Up/+/Down/- optional-display-name

# Examples:
# ./screen-brightness-xrandr.sh Down # primary display brightness down 5%
# ./screen-brightness-xrandr.sh + DP-1-1 # DP-1-1 display brightness up 5%
